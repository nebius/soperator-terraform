          ...
          slurm-exporter.json: |-
            {
                ...
                "panels": [
                    ...
                    "targets": [
                        ...
                        "editorMode": "code",
                        "expr": "slurm_job_nccl_benchmark_avg_bandwidth[3h]",
                        "instant": false,
                    ...
                    "title": "nccl benchmark avg bandwidth",
                    "type": "gauge"
                    },
                    {
                    "datasource": {
                    ...
                    "targets": [
                        ...
                        "editorMode": "code",
                        "expr": "slurm_job_nccl_benchmark_succeed[3h]",
                        "instant": false,
                        "legendFormat": "{{slurm_node}}",
                        "range": true,
                        "refId": "A"
                    ...
                    "targets": [
                        ...
                        "editorMode": "code",
                        "expr": "slurm_job_nccl_benchmark_limit_value[3h]",
                        "instant": false,
                        "legendFormat": "{{slurm_node}}",
                        "range": true,
                        "refId": "A"
                    ...
                    "title": "nccl benchmark limit value",
                    "type": "gauge"
                    },
                    {
                    "collapsed": false,
