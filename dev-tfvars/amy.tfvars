...
#k8s_network_id = "btc98puo770uh2gjppus"
...
k8s_cluster_subnet_cidr_blocks = ["10.130.0.0/24"]
...
k8s_cluster_node_group_gpu = {
  ...
  gke_accelerator = "nvidia-a100-80gb"
...
k8s_cluster_node_group_non_gpu = {
  name = "k8s-ng-non-gpu-slurm-a100"
...
slurm_cluster_node_worker_slurmd_resources = {
  cpu_cores               = 52
  memory_bytes            = 210 * (1024 * 1024 * 1024) # 210Gi
...
slurm_cluster_nccl_benchmark_drain_nodes = false
